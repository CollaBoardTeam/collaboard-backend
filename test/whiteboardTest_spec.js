...
describe('Routing testing suite', function () {
   ...
   describe('Test @ /whiteboard/', function (){
       ...
       it('returns wbs by user', function (done) {
           var out = '{"error":false,"message":[{"idWhiteBoard":1,"boardName":"WhiteBoard sample","idLayoutFK":1,"boardDate":"2016-11-16T00:00:00.000Z","description":"owner","fullName":"usetest","locked":1}]}'
           auth(function (cb) {
            request.get({
                headers: { 'x-access-token': cb },
                url: baseUrl + 'whiteboard/wbs-by-user/1'
